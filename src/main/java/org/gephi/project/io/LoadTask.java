...
public class LoadTask implements LongTask, Runnable {
    ...
    public void run() {
        ...
        // Progress.setDisplayName(progressTicket,
        // NbBundle.getMessage(LoadTask.class, "LoadTask.name"));
        ...
        //
        // @Override
        // public void report(String message, String errorType, Object
        // relatedInformation, Location location) throws XMLStreamException {
        // System.out.println("Error:" + errorType + ", message : " + message);
        // }
        // });
        // InputStreamReader isReader = new
        // InputStreamReader(fileObject.getInputStream(), "UTF-8");
        // Xml10FilterReader filterReader = new Xml10FilterReader(isReader);
        // XMLStreamReader reader =
        // inputFactory.createXMLStreamReader(filterReader);
        //
        // if (!cancel) {
        // //Project instance
        ...
        // //Add project
        // if (!cancel) {
        // ProjectControllerImpl pc =
        // Lookup.getDefault().lookup(ProjectControllerImpl.class);
    ...
    public class Xml10FilterReader extends FilterReader {
        ...
        public int read(char[] cbuf, int off, int len) throws IOException {
            ...
            /*
             * pos will show the index where chars should be moved if there are
             * gaps from invalid characters.
             */
            int pos = off - 1;
