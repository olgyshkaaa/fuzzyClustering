...
public class SaveTask implements LongTask, Runnable {
    ...
    public void run() {
        ...
        // NbBundle.getMessage(SaveTask.class, "SaveTask.name"));
        ...
        // //Stream
        // int zipLevel =
        // NbPreferences.forModule(SaveTask.class).getInt(ZIP_LEVEL_PREFERENCE,
        // 9);
        ...
        // outputFactory.createXMLStreamWriter(bufferedOutputStream, "UTF-8");
