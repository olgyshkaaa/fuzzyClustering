...
/**
 * Implementation of the AttributeColumnsController interface declared in the
 * Data Laboratory API.
 *
...
public class AttributeColumnsControllerImpl implements AttributeColumnsController {
    ...
    public boolean setAttributeValue(Object value, Attributes row, AttributeColumn column) {
        ...
        if (value != null && !value.getClass().equals(targetType.getType())) {
            try {
                value = targetType.parse(value.toString());// Try to convert to
                // target type
            } catch (Exception ex) {
        ...
        if (value == null && !canClearColumnData(column)) {
            return false;// Do not set a null value when the column can't have a
            // null value.
        } else {
    ...
    public void clearNodeData(Node node, AttributeColumn[] columnsToClear) {
        clearRowData(node.getNodeData().getAttributes(), columnsToClear);
    }
    ...
    public void clearEdgeData(Edge edge, AttributeColumn[] columnsToClear) {
        clearRowData(edge.getEdgeData().getAttributes(), columnsToClear);
    }
    ...
    public Number[] getRowNumbers(Attributes row, AttributeColumn[] columns) {
        ...
        for (AttributeColumn column : columns) {
            ...
            } else if (attributeUtils.isNumberListColumn(column)) {// Number
                // list
                // column:
                numbers.addAll(getNumberListColumnNumbers(row, column));
            } else if (attributeUtils.isDynamicNumberColumn(column)) {// Dynamic
                // number
                // column
    ...
    public void importCSVToNodesTable(File file, Character separator, Charset charset, String[] columnNames, AttributeType[] columnTypes, boolean assignNewNodeIds) {
        ...
        // {
        // throw new IllegalArgumentException("Column names length must be the
        // same as column types lenght");
        // }
        //
        // CsvReader reader = null;
        // try {
        // //Prepare attribute columns for the column names, creating the not
        // already existing columns:
        // AttributeTable nodesTable =
        // Lookup.getDefault().lookup(AttributeController.class).getModel().getNodeTable();
        // String idColumn = null;
        // ArrayList<AttributeColumn> columnsList = new
        // ArrayList<AttributeColumn>();
        // HashMap<AttributeColumn, String> columnHeaders = new
        // HashMap<AttributeColumn, String>();//Necessary because of column name
        // case insensitivity, to map columns to its corresponding csv header.
        // for (int i = 0; i < columnNames.length; i++) {
        // //Separate first id column found from the list to use as id. If more
        // are found later, the will not be in the list and be ignored.
        ...
        // } else {
        // AttributeColumn column = addAttributeColumn(nodesTable,
        ...
        // Graph graph =
        // Lookup.getDefault().lookup(GraphController.class).getModel().getGraph();
        // String id = null;
        // Node node;
        // Attributes nodeAttributes;
        // reader = new CsvReader(new FileInputStream(file), separator,
        // charset);
        ...
        // setAttributeValue(reader.get(columnHeaders.get(column)),
        // nodeAttributes, column);
        // }
        // }
    ...
    public void importCSVToEdgesTable(File file, Character separator, Charset charset, String[] columnNames, AttributeType[] columnTypes, boolean createNewNodes) {
        ...
        // ArrayList<AttributeColumn>();
        // HashMap<AttributeColumn, String> columnHeaders = new
        // HashMap<AttributeColumn, String>();// Necessary
        // // because
        // // of
        // // column
        // // name
        ...
        // // header.
        // for (int i = 0; i < columnNames.length; i++) {
        // // Separate first id column found from the list to use as id. If
        // // more are found later, the will not be in the list and be
        // // ignored.
        // if (columnNames[i].equalsIgnoreCase("id")) {
        // if (idColumn == null) {
        // idColumn = columnNames[i];
        // }
        // } else if (columnNames[i].equalsIgnoreCase("source") && sourceColumn
        // == null) {// Separate
        // // first
        // // source
        // // column
        ...
        // } else if (columnNames[i].equalsIgnoreCase("target") && targetColumn
        // == null) {// Separate
        // // first
        // // target
        // // column
        ...
        // } else if (columnNames[i].equalsIgnoreCase("type") && typeColumn ==
        // null) {// Separate
        // // first
        // // type
        // // column
        ...
        // columnHeaders.put(column, columnNames[i]);
        // } else {
        // AttributeColumn column = addAttributeColumn(edgesTable,
        // columnNames[i], columnTypes[i]);
        // if (column != null) {
        // columnsList.add(column);
        // columnHeaders.put(column, columnNames[i]);
        ...
        //
        // if (sourceId == null || sourceId.isEmpty() || targetId == null ||
        // targetId.isEmpty()) {
        // continue;// No correct source and target ids were provided,
        // // ignore row
        // }
        //
        // graph.readLock();
        ...
        //
        // if (source == null) {
        // if (createNewNodes) {// Create new nodes when they don't
        // // exist already and option is
        // // enabled
        // if (source == null) {
        // source = gec.createNode(null, sourceId);
        // }
        // } else {
        // continue;// Ignore this edge row, since no new nodes
        // // should be created.
        // }
        // }
        //
        ...
        // // Undirected if indicated correctly, otherwise always
        // // directed:
        // if (type != null) {
        ...
        // id = reader.get(idColumn);
        // if (id == null || id.isEmpty()) {
        // edge = gec.createEdge(source, target, directed);// id
        // // null
        // // or
        // // empty,
        // // assign
        ...
        // }
        // if (edge != null) {
        // // Increase edge weight with specified weight (if
        // // specified), else increase by 1:
        // String weight =
        // reader.get(columnHeaders.get(edgesTable.getColumn(PropertiesColumn.EDGE_WEIGHT.getIndex())));
        // if (weight != null) {
        // try {
        // Float weightFloat = Float.parseFloat(weight);
        // edge.getEdgeData().getAttributes().setValue(PropertiesColumn.EDGE_WEIGHT.getIndex(),
        // edge.getWeight() + weightFloat);
    ...
    /**
     * Only checks that a column is not <code>COMPUTED</code> or
     * <code>DELEGATE</code>
     */
    ...
    /**
     * Used for obtaining a list of the numbers of row of a dynamic number
     * column.
     */
