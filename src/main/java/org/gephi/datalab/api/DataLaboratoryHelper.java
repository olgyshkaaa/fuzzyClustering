...
public class DataLaboratoryHelper {
    ...
    /**
     * <p>
     * Prepares an array with one new instance of every NodesManipulator that
     * has a builder registered and returns it.
     * </p>
     * <p>
     * It also returns the manipulators ordered first by type and then by
     * position.
     * </p>
     *
    ...
    /**
     * <p>
     * Prepares an array with one new instance of every EdgesManipulator that
     * has a builder registered and returns it.
     * </p>
     * <p>
     * It also returns the manipulators ordered first by type and then by
    ...
    /**
     * <p>
     * Prepares an array with one instance of every GeneralActionsManipulator
     * that is registered.
     * </p>
     * <p>
     * It also returns the manipulators ordered first by type and then by
    ...
    /**
     * <p>
     * Prepares an array with one instance of every
     * PluginGeneralActionsManipulator that is registered.
     * </p>
     * <p>
     * It also returns the manipulators ordered first by type and then by
     * position.
    ...
    /**
     * <p>
     * Prepares an array that has one instance of every
     * AttributeColumnsManipulator implementation that has a builder registered
     * and returns it.
     * </p>
     * <p>
     * It also returns the manipulators ordered first by type and then by
    ...
    /**
     * <p>
     * Prepares an array with one new instance of every
     * AttributeValueManipulator that has a builder registered and returns it.
     * </p>
     * <p>
     * It also returns the manipulators ordered first by type and then by
     * position.
    ...
    /**
     * <p>
     * Prepares an array that has one new instance of every
     * AttributeColumnsMergeStrategy implementation that is registered.
     * </p>
     * <p>
     * It also returns the manipulators ordered first by type and then by
     * position.
     ...
     * <p>
     * Prepares an array that has one new instance of every
     * AttributeRowsMergeStrategy implementation that is registered.
     * </p>
     * <p>
     * It also returns the manipulators ordered first by type and then by
     * position.
    ...
    /**
     * Prepares the dialog UI of a manipulator if it has one and executes the
     * manipulator in a separate Thread when the dialog is accepted or directly
     * if there is no UI.
     *
    ...
    public void executeManipulator(final Manipulator m) {
        ...
        // //Show a dialog for the manipulator UI if it provides one. If not,
        // execute the manipulator directly:
        // if (ui != null) {
        // final JButton okButton = new
        // JButton(NbBundle.getMessage(DataLaboratoryHelper.class,
        // "DataLaboratoryHelper.ui.okButton.text"));
        ...
        // NbBundle.getMessage(DataLaboratoryHelper.class,
        // "SettingsPanel.title", ui.getDisplayName()), ui.isModal(), new
        // ActionListener() {
        //
    ...
    /**
     * This method shows the UI of an AttributeRowsMergeStrategy if it is
     * provided and the AttributeRowsMergeStrategy can be executed. These UI
     * only configures (calls unSetup) the AttributeRowsMergeStrategy if the
     * dialog is accepted, and it does not execute the
    ...
    /**
     * Prepares the dialog UI of a AttributeColumnsManipulator if it has one and
     * executes the manipulator in a separate Thread when the dialog is accepted
     * or directly if there is no UI.
     *
    ...
    public void executeAttributeColumnsManipulator(final AttributeColumnsManipulator m, final AttributeTable table, final AttributeColumn column) {
        ...
        // // Show a dialog for the manipulator UI if it provides one.
        // // If not, execute the manipulator directly:
        // if (ui != null) {
        // final JButton okButton = new
        // JButton(NbBundle.getMessage(DataLaboratoryHelper.class,
        // "DataLaboratoryHelper.ui.okButton.text"));
        ...
        // DialogDescriptor dd = new DialogDescriptor(settingsPanel,
        // NbBundle.getMessage(DataLaboratoryHelper.class,
        // "SettingsPanel.title", ui.getDisplayName()), ui.isModal(),
        // new ActionListener() {
        //
        // @Override
        // public void actionPerformed(ActionEvent e) {
    ...
    /**
     * Returns the AttributeColumnsMergeStrategy with that class name or null if
     * it does not exist
     */
    ...
    /**
     * Returns the AttributeRowsMergeStrategy with that class name or null if it
     * does not exist
     */
