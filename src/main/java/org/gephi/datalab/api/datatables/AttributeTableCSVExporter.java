...
public class AttributeTableCSVExporter {
     ...
     * @param separator       Separator to use for separating values of a row in the CSV
     *                        file. If null ',' will be used.
     * @param charset         Charset encoding for the file
     * @param columnsToExport Indicates the indexes of the columns to export. All columns
