...
public class AbstractEdgeTree {
    ...
    public boolean add(AbstractEdge item) {
        AbstractEdgeAVLNode p = this.root;

        if (p == null) {
            this.root = new AbstractEdgeAVLNode(item);
        } else {
            while (true) {
                ...
                if (c < 0) {
                    if (p.left != null) {
                        ...
                        p.left = new AbstractEdgeAVLNode(item, p);
                        p.balance--;
                    ...
                    if (p.right != null) {
                        ...
                        p.right = new AbstractEdgeAVLNode(item, p);
                        p.balance++;
    ...
    public boolean remove(AbstractEdge item) {
    ...
    public boolean remove(int number) {
        ...
        while (p != null) {
            ...
            if (c < 0) {
                ...
                AbstractEdgeAVLNode y; // node from which rebalancing begins
                ...
                {
                    AbstractEdgeAVLNode s = p.right.left;
    ...
    public boolean contains(AbstractEdge item) {
        AbstractEdgeAVLNode p = this.root;
    ...
    public AbstractEdge get(int number) {
        AbstractEdgeAVLNode p = this.root;
    ...
    public AbstractEdgeIterator iterator() {
        return new AbstractEdgeAVLIterator(this);
    }
    ...
    private class AbstractEdgeAVLNode {
        ...
        public AbstractEdgeAVLNode(AbstractEdge item) {
            this.item = item;
        }

        public AbstractEdgeAVLNode(AbstractEdge item, AbstractEdgeAVLNode parent) {
            this.item = item;
            this.parent = parent;
        }
    }
    ...
    private class AbstractEdgeAVLIterator extends AbstractEdgeIterator implements Iterator<AbstractEdge>, ResetableIterator {
        ...
        public AbstractEdgeAVLIterator(AbstractEdgeTree tree) {
            this(tree.root);
        }
        ...
        public void remove() {
            AbstractEdgeTree.this.remove(current);
        }
    }
}
